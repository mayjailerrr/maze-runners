...
{
    static Dictionary<AbilityName, Func<Context, bool>> abilities = new Dictionary<AbilityName, Func<Context, bool>>
    {
        // { AbilityName.ForestSpirit, Teletransport }, 
        // { AbilityName.ShapeShift, ChangeShapeAndAvoidTrapsForOneTurn }, 
    ...
    public static Func<Context, bool> GetAbility(AbilityName abilityName)
    {
