...
public static class PieceFactory
{
    public static List<Piece> CreatePieces(Movies movie)
    {
        ...
        {
            case Movies.Ponyo:
                pieces.Add(new Piece("Ponyo", 4, 3));
                pieces.Add(new Piece("Sosuke", 2, 1));
                pieces.Add(new Piece("Granmamare", 5, 3));
                break;

            case Movies.HowlsMovingCastle:
                pieces.Add(new Piece("Howl", 5, 4));
                pieces.Add(new Piece("Sophie", 3, 1));
                pieces.Add(new Piece("TurnipHead", 2, 1));
                break;
